...
<body style="background:#efefef; margin:0; padding:0;">
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;">
    <tbody>
      <tr>
        <td align="center" valign="middle" bgcolor="#6e6a6a" style="padding:15px; margin:0; line-height:0; border-top:2px solid #6e6a6a; border-bottom:1px solid #6e6a6a;"><a target="_blank" href="{{route('site.home')}}"><img src="{{asset('images/site/logo.png')}}" alt="" style="border:0;" width="182" height="52" /></a></td>
      </tr>
      <tr>
        <td align="left" valign="top" bgcolor="#ffffff" style="color:#3c3c3c; margin:0; padding:15px 15px 30px 15px; border-left: 1px solid #6e6a6a; border-right: 1px solid #6e6a6a;">
          @yield('content')
        </td>
      </tr>
      <tr>
        <td align="center" valign="middle" bgcolor="#6e6a6a" style="padding:20px; color:#ffffff; margin:0; line-height:0;">
          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="70%" align="left" valign="middle">
                <a style="color:#ffffff; text-decoration:none;" target="_blank">Terms & Condition</a> | <a style="color:#ffffff; text-decoration:none;" target="_blank">Privacy Policy</a>
              </td>
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#212529" style="padding:20px; color:#ffffff; margin:0; line-height:0;">©Copyright {{date('Y')}}. All Right Reserve.</td>
      </tr>
    </tbody>
  </table>
</body>
