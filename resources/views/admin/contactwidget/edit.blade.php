...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.contactwidget.list')}}"><i class="fa fa-cubes"></i> Contact Widget List</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.contactwidget.editsubmit', $details["id"]],
                                    'title'  => 'editContactwidgetForm',
                                    'id'    => 'editContactwidgetForm',
                                    'files' => true,
		                            'novalidate' => true)) }}
                    <div class="box-body">
                        <div class="row">
                        ...
                        <div class="box-footer">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('admin.contactwidget.list').'?page='.$data['pageNo'] }}" class="btn btn-block btn-default btn_width_reset">Cancel</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
