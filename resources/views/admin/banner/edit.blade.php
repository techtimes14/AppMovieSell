                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="UploadBannerWeb">Mobile Image</label><br>
                                {{ Form::file('mobile_image', array(
                                                            'id' => 'mobile_image',
                                                            'class' => 'form-control',
                                                            'placeholder' => 'Image' )) }}
                            </div>
                            <span>Select file dimensions {{AdminHelper::ADMIN_BANNER_MOBILE_THUMB_IMAGE_WIDTH}}px X {{AdminHelper::ADMIN_BANNER_MOBILE_THUMB_IMAGE_HEIGHT}}px</span>

                            <div class="form-group">
                                @if ($details['mobile_image'] != null)
                                    @if(file_exists(public_path('/uploads/banner/'.$details['mobile_image']))) 
                                        <embed src="{{ asset('uploads/banner/'.$details['mobile_image']) }}" width="100px" />
                                    @endif
                                @endif
                            </div>
                        </div>
